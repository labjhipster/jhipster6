  ...
  describe('Post Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Blog query and add missing value', () => {
        ...
        const blog: IBlog = { id: 56227 };
        post.blog = blog;

        const blogCollection: IBlog[] = [{ id: 61494 }];
      ...
      it('Should call Tag query and add missing value', () => {
        const post: IPost = { id: 456 };
        const tags: ITag[] = [{ id: 87111 }];
        post.tags = tags;

        const tagCollection: ITag[] = [{ id: 52091 }];
      ...
      it('Should update editForm', () => {
        const post: IPost = { id: 456 };
        const blog: IBlog = { id: 4244 };
        post.blog = blog;
        const tags: ITag = { id: 97628 };
        post.tags = [tags];
